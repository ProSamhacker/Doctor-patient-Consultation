...
// CORRECT IMPORT:
import com.example.hospitalmanagement.databinding.ActivityRoleSelectionBinding 
...
class RoleSelectionActivity : AppCompatActivity() {
    ...
    private fun selectRole(role: UserType) {
        ...
        if (role == UserType.DOCTOR) {
            // NOTE: Ensure 'strokeWidth' is supported by your MaterialCardView version 
            // or use app:strokeWidth in XML. Programmatically it is often setStrokeWidth(int).
